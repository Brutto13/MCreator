...
import net.mcreator.arduinomod.block.ProjectTableBlock;
...
public class ArduinoModModBlocks {
	...
	public static final RegistryObject<Block> PROJECT_TABLE = REGISTRY.register("project_table", () -> new ProjectTableBlock());
