...
public class WorkstationGUIScreen extends AbstractContainerScreen<WorkstationGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("arduino_mod:textures/workstation_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 36, this.topPos + 36, 0, 0, 13, 13, 13, 13);

		RenderSystem.setShaderTexture(0, new ResourceLocation("arduino_mod:textures/upgradetableiconinto.png"));
		this.blit(ms, this.leftPos + 75, this.topPos + 35, 0, 0, 22, 15, 22, 15);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "workstation", 36, 5, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 101, this.topPos + 7, 40, 20, new TextComponent("USE"), e -> {
		}));
	}
}
