...
public class PCBCreatorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCBCreatorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArduinoModModMenus.PCB_CREATOR_GUI, id);
